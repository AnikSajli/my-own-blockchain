...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 18 16:12:30 2022
pip install request==2.18.4
@author: anik
"""
...
class Blockchain:
    ...
    # find out the longest chain in the network and replace other shorter chains with it
    def replace_chain(self):
        ...
        for node in network:
            ...
            print("node", node)
            response = requests.get(f'http://192.168.8.105:5001/get_chain')
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Anik', amount = 1)
...
def connect_node():
    ...
    response = {'message': 'All nodes are connected. Node list: ',
